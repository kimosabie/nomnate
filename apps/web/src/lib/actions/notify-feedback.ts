        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;">
          ...
          <div style="background:#f9f9f9;border-radius:12px;padding:16px;margin-bottom:24px;">
            <table style="width:100%;font-size:13px;color:#666;">
              <tr><td style="padding:4px 0;font-weight:600;width:120px;">Type</td><td>${label}</td></tr>
              <tr><td style="padding:4px 0;font-weight:600;">From</td><td>${userName ?? 'Unknown'}</td></tr>
              <tr><td style="padding:4px 0;font-weight:600;">Family</td><td>${familyName ?? 'Unknown'}</td></tr>
              <tr><td style="padding:4px 0;font-weight:600;">Page</td><td>${pageUrl}</td></tr>
            </table>
          </div>
