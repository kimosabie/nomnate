...
| B8 | Structured daily course slots (starter/main/dessert) | 🟠 high | **In progress** — B8.1 (#5), B8.2 (#6), B8.3a (#7), B8.3b (#8) shipped; B8.3c done; B8.4 remains | [B8-COURSE-SLOTS-SCOPE.md](./B8-COURSE-SLOTS-SCOPE.md) |
