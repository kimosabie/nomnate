...
| B8 | Structured daily course slots (starter/main/dessert) | 🟠 high | **Scoped** — phased plan (B8.1–B8.4); B8.1 in progress | [B8-COURSE-SLOTS-SCOPE.md](./B8-COURSE-SLOTS-SCOPE.md) |
