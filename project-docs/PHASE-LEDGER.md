...
| B7 | Nutritional data so calorie tracking works | 🟠 high | **In progress** — B7.1 (#11), B7.2 (#12) shipped; B7.3 (diary UI) done; B7.4 (quick-log) remains | [B7-NUTRITION-TRACKING-SCOPE.md](./B7-NUTRITION-TRACKING-SCOPE.md) |
