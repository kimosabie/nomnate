...
| B12 | Party/braai event-planning section | 🟡 medium | **In progress** — B12.1 (backend, #15), B12.2 (events UI) done; B12.3 (AI menu) + B12.4 (scaled shopping) remain | [B12-EVENTS-SCOPE.md](./B12-EVENTS-SCOPE.md) |
